...
function SessionPage() {
  ...
  const visibleTestCaseCount =
    problemData?.visibleTestCaseCount ?? problemData?.visibleTestCases?.length ?? 0;
  const totalTestCaseCount = problemData?.totalTestCaseCount ?? activeProblem?.totalTestCaseCount ?? 0;
            ...
            <Panel defaultSize={72} minSize={isCompactLayout ? 58 : 56}>
              ...
              <Panel defaultSize={64} minSize={42}>
                <div className="h-full min-h-0 overflow-hidden bg-[#0d0f14] p-2">
                  ...
                  <Panel defaultSize={24} minSize={16} maxSize={44}>
